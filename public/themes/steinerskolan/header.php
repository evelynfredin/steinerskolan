...
<body class="min-h-screen font-sans bg-[#F8F4ED] overflow-x-hidden" <?php body_class(); ?>>
    ...
    <header class="lg:flex lg:justify-between items-center mx-auto bg-softGreen">
        ...
        <div class="hidden bg-menuOverlay w-screen lg:w-auto lg:flex lg:h-0 lg:pr-5 justify-center items-center h-screen text-schoolGreen" id="menuList">
            <div class="flex flex-col lg:flex-row justify-between items-center overflow-hidden">
                <ul class="flex flex-col items-center space-y-8 lg:space-y-0 lg:flex-row lg:space-x-4 py-2 px-8">
